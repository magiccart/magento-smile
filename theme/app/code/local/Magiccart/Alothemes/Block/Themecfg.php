 ...
 * @@Modify Date: 2015-07-02 09:13:02
 * @@Function:
 */
...
class Magiccart_Alothemes_Block_Themecfg extends Mage_Core_Block_Template
{
	...
	public function getThemecfg()
	{
		...
		if($isSecure) $html  = '<link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family='.str_replace(' ', '+', $font['google']).'" media="all" />';
		else $html  = '<link rel="stylesheet" type="text/css" href="http://fonts.googleapis.com/css?family='.str_replace(' ', '+', $font['google']).'" media="all" />';
		$html  .= "\n"; // break line;
		/* CssGenerator */
