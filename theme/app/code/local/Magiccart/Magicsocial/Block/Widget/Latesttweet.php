 ...
 * @@Modify Date: 2014-11-16 11:09:02
 * @@Function:
 */
?>
<?php
class Magiccart_Magicsocial_Block_Widget_Latesttweet 
	...
	implements Mage_Widget_Block_Interface
{
	...
	{
		// if(!$this->tweetCfg) $this->tweetCfg = Mage::helper('magicsocial')->getTwitterCfg();
		$t = array();
		$i = 0;
	...
	{
		require_once('magiccart/twitter/twitteroauth.php');
		if(!$this->tweetCfg) $this->tweetCfg = Mage::helper('magicsocial')->getTwitterCfg();			
		...
		$not 				= $this->tweetCfg['numberoftweets'];	
