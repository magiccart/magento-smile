	                   ...
	                   if(meanShowChildren) {
	                       ...
	                       if(meanExpandableChildren){
	                           ...
	                           jQuery('.mean-nav ul ul').show();   
                                ...
                                // jQuery('.level-top').on("click",function(e){
                                //     jQuery(this).siblings().children('a.mean-expand').text(meanExpand);
                                //     jQuery(this).siblings().children('a.mean-expand').removeClass('mean-clicked');
                                //     jQuery(this).siblings().children('ul').slideUp(300, function(){});
                                // }); 
